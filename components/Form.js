...
class Form extends Component {
    ...
    findCalc = () => {
        ...
        let credit = ((((parseInt(mark1)/10))*credit1.valueOf())+(((parseInt(mark2)/10))*credit2.valueOf())+(((parseInt(mark3)/10))*credit3.valueOf())+(((parseInt(mark4)/10))*credit4.valueOf())+(((parseInt(mark5)/10))*credit5.valueOf()))/denom;
    ...
    render() {
        return (
            ...
            >
                ...
                <View>
                    {this.state.live ? <Text> The CGPA is {this.state.cgpa}</Text> : null}
                </View>           
            </KeyboardAwareScrollView>
        );
    }
